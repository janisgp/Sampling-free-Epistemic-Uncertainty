...
class MonodepthModel(object):
    ...
    def __init__(self, params, mode, left, right, reuse_variables=None, model_index=0, use_dropout: bool=False):
        self.params = params
        self.mode = mode
        self.left = left
        self.right = right
    ...
    def build_vgg(self):
        ...
        with tf.variable_scope('decoder'):
            ...
            if self.use_dropout:
                iconv1 = tf.nn.dropout(iconv1, 0.1)
    ...
    def build_resnet50(self):
        ...
        with tf.variable_scope('decoder'):
            ...
            if self.use_dropout:
                concat1 = tf.nn.dropout(concat1, 0.5)
